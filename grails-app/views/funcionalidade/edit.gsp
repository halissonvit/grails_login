...
<body>
<a href="#edit-funcionalidade" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
                                                                     default="Skip to content&hellip;"/></a>
<g:sePermitido funcionalidade="Gerenciar Funcionalidades">

<div id="edit-funcionalidade" class="content scaffold-edit" role="main">
    ...
    <g:form method="post">
        ...
        <g:hiddenField name="version" value="${funcionalidadeInstance?.version}"/>
        <fieldset class="form">
